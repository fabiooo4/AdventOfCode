...
set softtabstop=2
set noswapfile
set tabline=%4@barbar#events#main_click_handler@%#BufferInactiveSign#▎%#BufferInactive#\ \ \ \ %#BufferInactive#󰈙\ %4@barbar#events#main_click_handler@%#BufferInactive#input.txt%#BufferInactive#\ \ \ \ %4@barbar#events#close_click_handler@%#BufferInactive#\ %4@barbar#events#main_click_handler@%#BufferInactiveSignRight#%6@barbar#events#main_click_handler@%#BufferCurrentSign#▎%#BufferCurrent#\ \ \ \ %#DevIconCCurrent#\ %6@barbar#events#main_click_handler@%#BufferCurrent#part1.c%#BufferCurrent#\ \ \ \ %6@barbar#events#close_click_handler@%#BufferCurrent#\ %6@barbar#events#main_click_handler@%#BufferCurrentSignRight#%#BufferInactiveSign#▎%#BufferTabpageFill#\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ %0@barbar#events#main_click_handler@%#BufferTabpageFill#
set tabstop=2
set termguicolors
