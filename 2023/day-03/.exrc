...
set softtabstop=2
set noswapfile
set tabline=%4@barbar#events#main_click_handler@%#BufferCurrentSign#▎%#BufferCurrent#\ \ \ \ %#DevIconCCurrent#\ %4@barbar#events#main_click_handler@%#BufferCurrent#day-03/part1.c%#BufferCurrent#\ \ \ \ %4@barbar#events#close_click_handler@%#BufferCurrent#\ %4@barbar#events#main_click_handler@%#BufferCurrentSignRight#%10@barbar#events#main_click_handler@%#BufferInactiveSign#▎%#BufferInactive#\ \ \ \ %#BufferInactive#\ %10@barbar#events#main_click_handler@%#BufferInactive#day-01/part1.c%#BufferInactive#\ \ \ \ %10@barbar#events#close_click_handler@%#BufferInactive#\ %10@barbar#events#main_click_handler@%#BufferInactiveSignRight#%#BufferInactiveSign#▎%#BufferTabpageFill#\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ %0@barbar#events#main_click_handler@%#BufferTabpageFill#
set tabstop=2
set termguicolors
